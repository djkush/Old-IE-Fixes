/* Fixes issues with IE < 9 - needs including at top of page
...
/**
* Swap out all IMG tags with SVGs and replace with PNG versions - needs a PNG fallback to work
* Based on http://callmenick.com/post/svg-fallback-with-png
**/
